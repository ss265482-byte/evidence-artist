...
export type SceneObjectType = 
  | 'body-outline' | 'body-standing' | 'body-prone' | 'body-seated' | 'body-fetal' | 'body-child' | 'body-crawling' | 'body-kneeling'
  | 'knife' | 'gun' | 'bullet-casing' | 'bullet-hole' | 'rifle' | 'shotgun' | 'bat' | 'crowbar' | 'rope' | 'axe' | 'hammer' | 'taser' | 'pepper-spray' | 'brass-knuckles'
  ...
  | 'shoe' | 'glasses' | 'jewelry' | 'bottle' | 'can' | 'syringe' | 'tape-roll' | 'flashlight-ev'
  | 'bed' | 'table' | 'chair' | 'sofa' | 'cabinet' | 'nightstand' | 'dresser' | 'bookcase' | 'rug' | 'mirror' | 'tv-stand'
  | 'coffee-table' | 'dining-table' | 'recliner' | 'ottoman' | 'wardrobe' | 'crib' | 'bunk-bed' | 'futon'
  | 'door' | 'window' | 'wall' | 'stairs' | 'elevator' | 'column' | 'garage-door' | 'sliding-door' | 'archway'
  | 'french-door' | 'revolving-door' | 'fire-escape' | 'balcony' | 'skylight' | 'partition-wall' | 'half-wall'
  | 'car' | 'motorcycle' | 'bicycle' | 'pickup-truck' | 'suv' | 'van' | 'bus' | 'semi-truck' | 'police-car'
  | 'ambulance' | 'fire-truck' | 'taxi' | 'boat' | 'atv' | 'scooter'
  | 'golf-cart' | 'forklift' | 'tractor' | 'rv' | 'limo' | 'helicopter' | 'jet-ski'
  ...
  | 'gazebo' | 'flagpole' | 'utility-pole' | 'storm-drain' | 'speed-bump' | 'guard-rail'
  | 'stove' | 'fridge' | 'sink' | 'bathtub' | 'toilet' | 'shower' | 'microwave' | 'dishwasher' | 'washer-dryer' | 'counter'
  | 'kitchen-island' | 'pantry' | 'wine-rack' | 'garbage-disposal' | 'medicine-cabinet' | 'towel-rack' | 'bidet' | 'jacuzzi'
  | 'desk' | 'computer' | 'filing-cabinet' | 'bookshelf' | 'printer' | 'office-chair' | 'whiteboard' | 'safe' | 'lamp' | 'tv'
  | 'conference-table' | 'cubicle' | 'water-cooler' | 'shredder' | 'projector' | 'server-rack' | 'reception-desk' | 'copier'
  | 'hospital-bed' | 'gurney' | 'iv-stand' | 'wheelchair' | 'med-cabinet' | 'defibrillator' | 'first-aid' | 'oxygen-tank'
  | 'exam-table' | 'x-ray-machine' | 'crash-cart' | 'body-bag' | 'stretcher' | 'medical-waste' | 'sharps-container'
  | 'workbench' | 'toolbox' | 'shelving' | 'ladder' | 'generator' | 'electrical-panel' | 'water-heater' | 'furnace'
  | 'air-compressor' | 'drill-press' | 'circular-saw' | 'welding-station' | 'vise' | 'jack-stand' | 'oil-drum'
  | 'ceiling-light' | 'floor-lamp' | 'spotlight' | 'exit-sign' | 'security-camera' | 'smoke-detector' | 'sprinkler'
  | 'fire-extinguisher' | 'alarm-panel' | 'motion-sensor' | 'emergency-light' | 'strobe-light' | 'flood-light'
