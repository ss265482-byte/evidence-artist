...
export const objectLibrary: Record<string, ObjectTemplate[]> = {
  ...
  'Vehicles': [
    ...
    { type: 'ambulance', label: 'Ambulance', icon: '🚑', width: 120, height: 50, color: '#f5f5f4', category: 'Vehicles' },
    { type: 'fire-truck', label: 'Fire Truck', icon: '🚒', width: 160, height: 55, color: '#dc2626', category: 'Vehicles' },
    { type: 'tow-truck', label: 'Tow Truck', icon: '🚚', width: 130, height: 50, color: '#f59e0b', category: 'Vehicles' },
